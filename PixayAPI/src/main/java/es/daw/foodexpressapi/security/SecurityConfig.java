...
//                }))
                ...
                ¿Por qué NO necesitas CSRF en una API REST?
                    ...
                    - No hay formulario web ni sesiones HTML (como en aplicaciones MVC tradicionales).
                    - En API REST las peticiones maliciosas no pueden inyectar headers personalizados como Authorization desde un navegador,
...
//                        .requestMatchers(HttpMethod.PUT,"/api/productos/**").hasRole("ADMIN") //tienes que ser rol admin para poder acceder
    ...
    // No lo necesitas si tod0 el proceso de autenticación lo maneja Spring automáticamente, como cuando usas formLogin()
